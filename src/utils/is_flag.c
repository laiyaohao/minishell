...
/**
 * @brief Checks if a given string represents a flag composed of a specific character.
 * 
 ...
 * @return 1 if the string is a valid flag composed of the character `c`, 0 otherwise.
 */
